            ...
            return(
              <Link to={`/blog/${element._id}`} key={element._id} className='bg-white rounded-lg hover:shadow-lg overflow-hidden transform hover:scale-105 transition-transform duration-300'>
                <div className='group relative'>
                  ...
                  <div className='absolute inset-0 bg-gradient-to-t from-black via-transparent to-transparent opaccity-75 group-hover:opacity-100 transition-transform duration-300'></div>
                ...
                <div className='p-6 flex items-center'>
                  <img src={element.adminPhoto} alt="" className='w-12 rounded-full border-2 border-purple-400'/>
                  <div className='ml-4'>
